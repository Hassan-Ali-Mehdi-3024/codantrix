...
-- ============================================================
-- POST 3 — "Build vs buy: agent platforms in 2026"
-- ============================================================

DELETE FROM posts WHERE slug = 'build-vs-buy-agent-platforms-in-2026';

INSERT INTO posts (
  slug, title, excerpt, cover_image_key, cover_alt, body_md,
  status, published_at, created_at, updated_at, reading_time_min, word_count
) VALUES (
  'build-vs-buy-agent-platforms-in-2026',
  'Build vs buy — agent platforms in 2026',
...
#building #architecture #lessons',
  'published',
  strftime('%s', '2026-04-28 12:00:00') * 1000,
  strftime('%s', '2026-04-28 12:00:00') * 1000,
  strftime('%s', '2026-04-28 12:00:00') * 1000,
  4,
  870
...
INSERT INTO post_tags (post_id, tag)
  SELECT id, 'building'     FROM posts WHERE slug = 'build-vs-buy-agent-platforms-in-2026';
INSERT INTO post_tags (post_id, tag)
  SELECT id, 'architecture' FROM posts WHERE slug = 'build-vs-buy-agent-platforms-in-2026';
INSERT INTO post_tags (post_id, tag)
  SELECT id, 'lessons'      FROM posts WHERE slug = 'build-vs-buy-agent-platforms-in-2026';
