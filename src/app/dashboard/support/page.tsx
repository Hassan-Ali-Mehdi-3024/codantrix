    ...
    <div className="space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
          ...
          <div className="p-8 nm-flat-md rounded-3xl border border-nm-text/5 text-left">
              ...
              <p className="text-nm-text-muted">Browse the <Link href="/dashboard/documents" className="text-nm-text font-bold hover:text-brand-orange transition-colors underline underline-offset-4">Shared Vault</Link> for self-service guides.</p>
          </div>
      </div>
    </div>
  )
