  ...
  return (
    <div className="space-y-12">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
        ...
        <Link href="/dashboard/projects" className="nm-btn-accent px-6 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest text-white hover:scale-105 transition-all">
          Create Project +
        </Link>
      </div>
      ...
      <div className="rounded-3xl nm-flat-lg border border-nm-text/5 overflow-hidden">
        <div className="p-8 border-b border-nm-text/5 flex items-center justify-between">
          ...
          <Link href="/dashboard/projects" className="text-brand-orange text-[10px] font-black uppercase tracking-widest hover:text-nm-text transition-colors">View All</Link>
        </div>
        <div className="p-4">
