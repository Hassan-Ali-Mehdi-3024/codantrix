    ...
    return (
        <div className="pt-40 pb-24 bg-nm-bg">
            <div className="max-w-[1380px] mx-auto px-4 sm:px-6 lg:px-8">
                <div className="max-w-3xl flex flex-col items-center text-center sm:items-start sm:text-left mx-auto sm:mx-0">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 mt-20">
                    ...
                    <div className="flex flex-col items-center text-center sm:items-start sm:text-left">
                        ...
                        <ul className="space-y-8 w-full">
                            <li className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                                <div className="text-3xl font-black text-brand-orange/20 leading-none shrink-0">01</div>
                            ...
                            <li className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                                <div className="text-3xl font-black text-brand-orange/20 leading-none shrink-0">02</div>
                                <div className="flex flex-col items-center sm:items-start">
                            ...
                            <li className="flex flex-col sm:flex-row items-center sm:items-start gap-6">
                                <div className="text-3xl font-black text-brand-orange/20 leading-none shrink-0">03</div>
                                <div className="flex flex-col items-center sm:items-start">
                ...
                {/* Founder Section */}
                <div className="mt-32 p-8 sm:p-10 lg:p-14 nm-flat-md border border-nm-text/5 rounded-3xl relative overflow-hidden flex flex-col items-center text-center sm:items-stretch sm:text-left">
                    ...
                    <div className="flex flex-col md:flex-row gap-12 items-center w-full">
                        <div className="w-48 h-48 nm-inset-sm rounded-3xl flex items-center justify-center text-5xl font-black text-brand-orange shrink-0">
                            HAM
                        </div>
                        <div className="flex-1 relative z-10 flex flex-col items-center md:items-start">
