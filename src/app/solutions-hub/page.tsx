        ...
        <div className="pt-32 pb-24 bg-[#1c1e20]">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="mt-24 text-center">
                    <div className="p-12 border border-[#fffdf2]/5 bg-[#161819] max-w-2xl mx-auto italic">
                        ...
                        <Link
                            href="/quiz"
                            className="inline-flex items-center gap-3 py-4 px-10 bg-[#f15a2f] text-[#fffdf2] font-black uppercase tracking-widest hover:translate-y-[-2px] transition-all text-xs"
                        >
