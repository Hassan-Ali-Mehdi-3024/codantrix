            ...
            <div className="max-w-2xl relative z-10">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col md:flex-row gap-4">
                    ...
                    <button
                        type="submit"
                        disabled={status === 'loading'}
                        className="px-10 py-4 bg-black text-[#fffdf2] font-black uppercase tracking-widest text-sm hover:scale-105 transition-all flex items-center justify-center gap-2"
                    >
